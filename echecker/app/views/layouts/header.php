...
<head>
    <?php
     include  __ROOT. 'public/css/grid.php';
     ?>
    <link href= "<?= __CSS . 'bootstrap.min.css';?>" rel="stylesheet" type="text/css"/> 
    <link href= "<?= __CSS . 'waves.min.css';?>" rel="stylesheet" type="text/css"/> 
    <link href= "<?= __CSS . 'animate.min.css';?>" rel="stylesheet" type="text/css"/> 
    ...
    <link href= "<?= __CSS . 'datepicker.css';?>" rel="stylesheet" type="text/css"/>
    <link href= "<?= __CSS . 'dataTables-bootstrap4.css';?>" rel="stylesheet" type="text/css"/>
    <link href= "<?= __CSS . 'semantic-ui.css';?>" rel="stylesheet" type="text/css"/>
